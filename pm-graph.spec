...
Version  : 5.13
Release  : 15
URL      : https://github.com/intel/pm-graph/archive/5.13/pm-graph-5.13.tar.gz
Source0  : https://github.com/intel/pm-graph/archive/5.13/pm-graph-5.13.tar.gz
...
%prep
%setup -q -n pm-graph-5.13
cd %{_builddir}/pm-graph-5.13
pushd ..
cp -a pm-graph-5.13 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726129214
