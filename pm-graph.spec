...
Version  : 5.9
Release  : 10
URL      : https://github.com/intel/pm-graph/archive/5.9/pm-graph-5.9.tar.gz
Source0  : https://github.com/intel/pm-graph/archive/5.9/pm-graph-5.9.tar.gz
...
%prep
%setup -q -n pm-graph-5.9
cd %{_builddir}/pm-graph-5.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655393127
...
cp %{_builddir}/pm-graph-5.9/COPYING %{buildroot}/usr/share/package-licenses/pm-graph/a7a897a4bde987e597c04f16a9c28f6d3f57916d
cp %{_builddir}/pm-graph-5.9/debian/copyright %{buildroot}/usr/share/package-licenses/pm-graph/c6968fc73b0c521cdaea80f5862460ea1fd7a317
%make_install
