...
Version  : 5.10
Release  : 11
URL      : https://github.com/intel/pm-graph/archive/5.10/pm-graph-5.10.tar.gz
Source0  : https://github.com/intel/pm-graph/archive/5.10/pm-graph-5.10.tar.gz
...
%prep
%setup -q -n pm-graph-5.10
cd %{_builddir}/pm-graph-5.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666278763
