...
Version  : 5.4
Release  : 3
URL      : https://github.com/intel/pm-graph/archive/5.4/pm-graph-5.4.tar.gz
Source0  : https://github.com/intel/pm-graph/archive/5.4/pm-graph-5.4.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1557843931
